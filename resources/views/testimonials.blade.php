                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <textarea name="description" class="form-control input-sm"
                                                placeholder="Description" id="description" rows="3" required></textarea>
...
$(".wait").show();
        ...
        $.ajax({
        url: "{{url('uploading_testimonial_img')}}",
        data: form_data,
        type: 'POST',
        contentType: false,
        processData: false,
...
var role="<?php echo $val=Session::get('role');?>";
    ...
    <script type='text/javascript' src="{{ URL::asset('/resources/js/myjs/testimonials.js',true) }}">
    </script>
