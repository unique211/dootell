...
<div id="wait" class="wait"
    style="width:100px;height:100px;position:absolute;top:50%;left:45%;padding:2px; display: none;">
    <img src="{{ env('APP_URL') }}/resources/img/loader.gif" width="100" height="100" /><br>
    <center>
        <h5>Please Wait...</h5>
    </center>
</div>
