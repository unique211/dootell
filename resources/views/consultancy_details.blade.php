    ...
    <div class="container  ">
        ...
        <div class="content">
            ...
            <div class="page-content-wrap">
                ...
                @foreach($consultancy_data as $val)
                <div class="form-group row">

                    <br>
                    <label class="col-lg-3 ">Consultancy Name</label>
                    <div class="col-lg-3">
                        <label>{{ $val->cunsultancy_name }}</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <label>{{ $val->cunsultancy_address }}</label>
                    </div>
                </div>
                <div class="form-group row">
            ...
            <form action="{{ url('payment_consultancy_renew') }}" method="POST" id="hidden_form" name="hidden_form">
                @csrf
