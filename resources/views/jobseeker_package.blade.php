    ...
    <div class="container">
        ...
        <div class="card horizontal">
            <div class="card-image">
                <img src="uploads/{{ $value->image  }}" class="fadeIn">
            </div>
            <div class="card-stacked">
                <div class="card-content">
                    ...
                    <ul style="list-style-type:square;">
                        ...
                        <li>With Technical support</li>
                    </ul>
                </div>
                <div class="card-action">
                    @if(is_null($reference_id))
                    <a href="{{ url('jobseeker_register') }}/{{ $value->id  }}" class="btn"
                        style="background-color:red">Buy</a>

                    @else
                    <a href="{{ url('jobseeker_details') }}/{{ $value->id  }}/{{ $reference_id  }}" class="btn"
                        style="background-color:red">Buy</a>
                    @endif
