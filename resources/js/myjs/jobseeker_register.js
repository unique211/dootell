$(document).ready(function() {
    ...
    function datashow() {
        ...
        $.get('get_all_jobseeker_lists', function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<tr>' +
                    ...
                    '<td id="cus_name_' + data[i].id + '"><img src = "uploads/Jobseeker/profile/' + data[i].profile_photo + '" class="img - thumbnail" style="width: 100px; height: 100px;" /></td>' +
    ...
    $(document).on('click', ".edit_data", function(e) {
        ...
        var id = $(this).attr("id");
        // alert(id);
        $.get('jobseeker/' + id + '/edit', function(data) {
            //  alert(id);
            $('#save_update').val(id);
            var date = data.date;
            var fdateslt = date.split('-');
