$(document).ready(function() {
    ...
    function datashow() {
        ...
        $.get('get_all_company_lists', function(data) {
            ...
            html += '<table id="laravel_crud" style="width:100%;" class=" table table-striped">' +
                ...
                '<th><font style="font-weight:bold">Company Logo</font></th>' +
                ...
                '<th><font style="font-weight:bold">Contact Person</font></th>' +
                '<th><font style="font-weight:bold">Email</font></th>' +
                '<th><font style="font-weight:bold">Mobile No.</font></th>' +
                '<th><font style="font-weight:bold">Industry Type</font></th>' +
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<tr>' +
                    ...
                    '<td id="cus_name_' + data[i].id + '"><img src = "uploads/Company/logo/' + data[i].logo + '" class="img - thumbnail" style="width: 100px; height: 100px;" /></td>' +
                    '<td id="cus_name_' + data[i].id + '">' + data[i].company_name + '</td>' +
                    '<td id="cus_name_' + data[i].id + '">' + date1 + '</td>' +
                    // '<td id="cus_name_' + data[i].id + '"></td>' +
                    '<td id="cus_name_' + data[i].id + '">' + data[i].contact_person + '</td>' +
                    '<td id="cus_name_' + data[i].id + '">' + data[i].email + '</td>' +
                    '<td id="cus_name_' + data[i].id + '">' + data[i].mobile + '</td>' +
                    '<td id="cus_name_' + data[i].id + '">' + data[i].industry_type + '</td>' +
                ...
                if (role == "Company") {
                    html += '<td class="not-export-column" ><button name="edit" value="edit" class="edit_data btn btn-xs btn-success" id=' + data[i].id +
    ...
    $(document).on('click', ".edit_data", function(e) {
        ...
        $.get('company/' + id + '/edit', function(data) {
            ...
            $('#date').val(date1);
            $('#contact_person_name').val(data.contact_person);
