$(document).ready(function() {
    ...
    function datashow() {
        ...
        $.get('get_all_testimonial', function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<tr>' +
                    ...
                    '<td id="id_' + data[i].id + '">' + data[i].title + '</td>' +
                    '<td id="id_' + data[i].id + '">' + data[i].description + '</td>' +
                    '<td id="cus_name_' + data[i].id + '"><img src = "uploads/testimonial/' + data[i].image + '" class="img-thumbnail" style="width:100px; height:100px;" /></td>';
                if (rights == 1) {
    ...
    $(document).on('click', ".edit_data", function(e) {
        ...
        var id = $(this).attr("id");
        // alert(id);
        $.get('testimonials/' + id + '/edit', function(data) {
            //  alert(id);
