$(document).ready(function() {
    ...
    function datashow() {
        ...
        $.get('get_all_subscriber_lists', function(data) {
            ...
            html += '<table id="laravel_crud" style="width:100%;" class=" table table-striped">' +
                ...
                '<th><font style="font-weight:bold">Aadhar</font></th>';
    ...
    $(document).on('click', ".edit_data", function(e) {
        ...
        var id = $(this).attr("id");
        // alert(id);
        $.get('subscriber/' + id + '/edit', function(data) {
            //  alert(id);
            $('#save_update').val(id);
            var date = data.date;
            var fdateslt = date.split('-');
