...
class Company_renew_Controller extends Controller
{
    public function order(Request $request)
    {
        ...
        if ($data2->package_price > 0) {
            ...
            $payment->prepare([
                ...
                'email' => $data->email,
                'amount' => $data2->package_price,
                'callback_url' => url('api/payment/status2')
            ]);
    ...
    public function renew_company()
    {
        ...
        $result2 = DB::table('company_register')
