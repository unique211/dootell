...
class TestimoinalsController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $customer   =   Testimonial::updateOrCreate(
            ['id' => $ID],
            [
                'title'        =>  $request->title,
    ...
    {
        $where = array('id' => $id);
        $customer  = Testimonial::where($where)->first();
    ...
    {
        $customer = Testimonial::where('id', $id)->delete();
        return Response::json($customer);
    }
    ...
    public function show_all()
    {
        ...
        $data = DB::table('testimonials_master')
    ...
    public function uploading_testimonial_img(Request $request)
    {
